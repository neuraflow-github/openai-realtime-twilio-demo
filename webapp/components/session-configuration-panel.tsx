...
const SessionConfigurationPanel: React.FC<SessionConfigurationPanelProps> = ({
  ...
  const backendToolsUrl = process.env.NEXT_PUBLIC_WEBSOCKET_URL 
    ? `${process.env.NEXT_PUBLIC_WEBSOCKET_URL}/tools` 
    : "http://localhost:8081/tools";
  const backendTools = useBackendTools(backendToolsUrl, 3000);
